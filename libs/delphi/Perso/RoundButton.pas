...
begin
  ...
  if (Value = Self) then raise Exception.Create('R�f�rences circulaires interdites');
...
begin
  // aucune v�rification car c'est une valeur calcul�e sur FAngle qui est utilis�e
