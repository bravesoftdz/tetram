...
// 0: pas de mise � jour
// 1: mise � jour et utilisateur demande � fermer l'appli
const
  ...
  try
    ...
    try
      ...
      try
        ...
        begin
          ...
          try
            ...
            if CurrentVersion < Trim(sl.Values['Version']) then begin
              ...
              ShowMessage('Votre version est � jour.');
          finally
            sl.Free;
          end;
        end
        ...
        begin
          ShowMessage('Impossible d''interroger le site de mise � jour.');
          Result := -1;
        end;
      finally
        ss.Free;
...
begin
  ...
  if FProgramme <> '' then
    Label3.Caption := Format('Votre version de %s est obsol�te.', [FProgramme, FVersion]);
  if FVersion <> '' then
    Label3.Caption := Label3.Caption + Format(#13#10'Rendez-vous sur le site pour obtenir la derni�re version (%s).', [FVersion]);
end;
