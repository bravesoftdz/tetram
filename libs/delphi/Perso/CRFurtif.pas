...
type
  TRGBArray = array[0..0] of TRGBTriple; // �l�ment de bitmap (API windows)
    ...
    case State of
      ...
      bsDisabled:
        if FDisableGrayed then begin
          // on prend l'icone "normal" pour la rendre d�sactiv�e: plus joli avec les nouvelles icones de CardioXP
          I := bsUp;
          ORect := Rect(Ord(I) * IWidth, 0, (Ord(I) + 1) * IWidth, IHeight);
