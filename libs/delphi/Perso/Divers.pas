...
begin
  ShowMessage('Dur�e ' + FLabel + ': ' + FormatDateTime('hh:mm:ss:zzz', Now - FStart));
  inherited;
end;
...
function IsPrevInstance: HWND;
// Retourne 0 si aucune instance n'est trouv�e
// sinon, retourne le handle de l'application trouv�e.
var
  ...
  begin
    ...
    begin
      if CharInSet(Ver[Index], ['0' .. '9']) then
        ...
        raise Exception.Create('"' + Ver + '" n''est pas un num�ro de version valide');
      Inc(Index);
    end;
