...
const
  ...
  ICU_DEFAULT_COMMON_MODULE_NAME = 'icuuc' + ICU_FILE_VERSION{$IFDEF DEBUG_ICU} + 'd'{$ENDIF} + '.dll';
  ICU_DEFAULT_I18N_MODULE_NAME = 'icuin' + ICU_FILE_VERSION{$IFDEF DEBUG_ICU} + 'd'{$ENDIF} + '.dll';
