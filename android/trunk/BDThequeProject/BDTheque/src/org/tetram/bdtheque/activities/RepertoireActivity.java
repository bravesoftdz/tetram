package org.tetram.bdtheque.activities;
...
import org.tetram.bdtheque.dao.EditeurLiteDao;

/**
 * Created by Thierry on 01/06/13.
 */
public class RepertoireActivity extends Activity {
    ...
    public static class TitlesFragment extends ListFragment {
        ...
        EditeurLiteDao editeurs;

        @Override
        public void onActivityCreated(Bundle savedInstanceState) {
            super.onActivityCreated(savedInstanceState);

            editeurs = new EditeurLiteDao(getActivity());

            // Populate list with our static array of titles.
            setListAdapter(new ArrayAdapter<EditeurLiteBean>(getActivity(),
                    android.R.layout.simple_list_item_activated_1, editeurs.getEditeurs()));
        ...
        void showDetails(int index) {
            ...
            if (mDualPane) {
                ...
                FicheFragment details = (FicheFragment)
