  ...
  begin
    ...
    begin
      ...
      for i := 0 to Pred(Album.Editions.Editions.Count) do
        Prn.WriteLineColumn(1, -1, TEditioncomplete(Album.Editions.Editions).ChaineAffichage);
    end;
  ...
  try
    ...
    try
      ...
      if Assigned(Edition) then
        ImprimeAlbum(Prn, Album, dsoAlbumsDetails, fWaiting)
      else
        ImprimeAlbum(Prn, Album, dsoEditionsDetaillees, fWaiting);
      ...
      Prn.CreateColumn1(0, 10, 30, taRightJustify, 'Times New Roman', 12, [fsBold]);
      Prn.CreateColumn1(1, 42, 30, taLeftJustify, 'Times New Roman', 12, []);
      Prn.CreateColumn1(2, 42, 30, taRightJustify, 'Times New Roman', 12, [fsBold]);
...
begin
  ...
  try
    ...
    try
      ...
      Prn.CreateColumn1(5, 25, -1, taLeftJustify, 'Times New Roman', 10, [fsItalic]); // résumé de la série
      Prn.SetTopOfPage;
      PAl := TAlbum.Create;
      with Source do
      begin
...
begin
  ...
  try
    ...
    try
      ...
      if Apres > -1 then Prn.SetHeaderInformation1(-1, -1, 'Après le ' + DateToStr(Apres), taCenter, 'Times New Roman', 12, [fsItalic]);
      Prn.SetFooterInformation1(0, 0, CopyrightTetramCorp, taRightJustify, 'Times New Roman', 9, []);
      Prn.SetDetailTopBottom(-1, -1);
      Prn.SetPageNumberInformation1(Prn.FooterCoordinates.Top + 5, rsTransPage + ' ', '', taCenter, 'Times New Roman', 10, [fsUnderline]);
      Prn.SetDateTimeInformation1(Prn.HeaderCoordinates.Top, dfShortDateFormat, True, dtStart, tfShortTimeFormat, True, DateFirst, ' - ', taRightJustify, 'Times New Roman', 9, []);
...
begin
  ...
  try
    ...
    try
      ...
      Prn.SetFooterDimensions1(-1, -1, -1, 15, False, 1, clWhite);
...
begin
  ...
  try
    ...
    try
      ...
      Prn.CreateColumn1(4, 35, -1, taLeftJustify, 'Times New Roman', 10, [fsItalic]); // résumé
      Prn.CreateColumn1(5, 35, -1, taLeftJustify, 'Times New Roman', 8, []); // réalisation, acteurs
      Prn.SetTopOfPage;
...
begin
  ...
  try
    ...
    Prn.SetFooterDimensions1(-1, -1, -1, 15, False, 0, clWhite);
    Prn.SetHeaderInformation1(0, 5, 'Séries incomplètes', taCenter, 'Times New Roman', 24, [fsBold]);
    Prn.SetFooterInformation1(0, 0, CopyrightTetramCorp, taRightJustify, 'Times New Roman', 9, []);
    Prn.SetDetailTopBottom(-1, -1);
    Prn.PageNumber.Printed := False;
    Prn.SetDateTimeInformation1(Prn.HeaderCoordinates.Top, dfShortDateFormat, True, dtStart, tfShortTimeFormat, True, DateFirst, ' - ', taRightJustify, 'Times New Roman', 9, []);
...
begin
  ...
  try
    ...
    Prn.SetHeaderDimensions1(Prn.Margin.Left, Prn.Margin.Right, Prn.Margin.Top, 20, False, 0, clWhite);
    Prn.SetFooterDimensions1(-1, -1, -1, 15, False, 0, clWhite);
    Prn.SetHeaderInformation1(0, 5, 'Prévisions de sorties', taCenter, 'Times New Roman', 24, [fsBold]);
    Prn.SetFooterInformation1(0, 0, CopyrightTetramCorp, taRightJustify, 'Times New Roman', 9, []);
    Prn.SetDetailTopBottom(-1, -1);
    Prn.PageNumber.Printed := False;
    Prn.SetDateTimeInformation1(Prn.HeaderCoordinates.Top, dfShortDateFormat, True, dtStart, tfShortTimeFormat, True, DateFirst, ' - ', taRightJustify, 'Times New Roman', 9, []);
...
begin
  ...
  try
    ...
    try
      ...
      Prn.SetHeaderInformation1(1, -1, Format('%d %s - %s', [NbAlbums div 2 {NbAlbums contient le double du nb d'albums}, rsTransAlbums, FormatCurr(FormatMonnaie, PrixTotal)]), taCenter, 'Times New Roman', 12, []);
