...
begin
  ...
  begin
    ...
    RegisterPropertyHelper(@TAlbumCompletEditions_R, nil, 'Editions');
...
//    RegisterPropertyHelper(@TSerieCompleteCollection_R, nil, 'Collection');
...
begin
  ...
  begin
    ...
    RegisterPropertyHelper(@TEditionCompleteCollection_R, nil, 'Collection');
...
begin
  ...
  RIRegister_TObjectListOfEditionComplete(CL);
