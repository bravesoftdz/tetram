...
<div id=detail_body>
	<TABLE border=0 width=100%>
		<TBODY valign=top>
			<TR>
				<TH align=right width=1>Série&nbsp;:</TH><TD width=100%><A href=# onclick="return AjaxUpdate('detail', 'ficheserie.php?ref=<? echo $album->id_serie ?>')"><? echo _out(display_titreserie($serie)) ?></A></TD>
...
<?
	...
	{
?>
					<A href=# onclick="return AjaxUpdate('detail', 'fichepersonne.php?ref=<?echo $row->id_personne?>')"><?echo _out(format_titre($row->nompersonne))?><br>
<?
	} 
?>
				</TD>
