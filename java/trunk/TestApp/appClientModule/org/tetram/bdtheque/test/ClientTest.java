...
public class ClientTest {
	...
	public static void main(String[] args) throws NamingException,
		...
		// final FactoryOfDaoFactories factoryOfFactories =
		// lookupRemoteStateless(FactoryOfDaoFactories.class);
		// final BDthequeDaoFactory factory =
		// factoryOfFactories.createBDthequeDaoFactory();
	...
	private static String buildEjbName(Class<?> e) {
		...
		// application
		// name could be overridden in the application.xml of the EJB deployment
		// on
		// the server.
		...
		// typically the jar name of the EJB deployment, without the .jar
		// suffix,
	...
	private static <T> T lookupRemoteStateless(Class<T> e)
			throws NamingException {
	...
	private static <T> T lookupRemoteStateful(Class<T> e)
			throws NamingException {
		final Hashtable<String, String> jndiProperties = new Hashtable<String, String>();
		jndiProperties.put(Context.URL_PKG_PREFIXES,
				"org.jboss.ejb.client.naming");
