...
public abstract class EntityPickerPopupControl<T> extends ComboBoxBaseSkin<T> {
    ...
    public EntityPickerPopupControl(ComboBoxBase<T> comboBox, final ComboBoxBaseBehavior<T> behavior) {
    ...
    private void positionAndShowPopup() {
        ...
        _popup.show(comboBoxBase, p.getX(), p.getY());
    ...
    private void createPopup() {
        popup = new PopupControl() {
            ...
            @Override public Styleable getStyleableParent() {
                return EntityPickerPopupControl.this.getSkinnable();
            }
            {
                setSkin(new Skin<Skinnable>() {
                    @Override public Skinnable getSkinnable() { return EntityPickerPopupControl.this.getSkinnable(); }
