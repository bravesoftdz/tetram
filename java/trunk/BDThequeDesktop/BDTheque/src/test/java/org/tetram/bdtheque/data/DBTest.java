...
public class DBTest {
    ...
    protected static final UUID ID_ALBUM_MAGASIN_GENERAL_TOME_11 = StringUtils.GUIDStringToUUID("{504EABDB-3A49-4AF7-9AEA-B4033478E343}");
    ...
    protected static final UUID ID_ALBUM_SPIROU_GALLERIE_DES_ILLUSTRES = StringUtils.GUIDStringToUUID("{225CD5DE-3700-4499-927A-449182CD3028}");
    protected static final UUID ID_AUTEUR_BUCHET = StringUtils.GUIDStringToUUID("{83F8F815-2DD3-4BA2-A037-57EEB0A1C5C8}");

    protected SqlSession dbSession;

    @Before
    public void setUp() throws Exception {
        dbSession = Database.getInstance().openSession();
    }
