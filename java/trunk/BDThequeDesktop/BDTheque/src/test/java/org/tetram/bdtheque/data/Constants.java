...
public class Constants {
    ...
    public static final String NOM_EDITEUR_GLÉNAT = "Glénat";
    public static final UUID ID_EDITEUR_DELCOURT = StringUtils.GUIDStringToUUID("{E76916B2-9678-420F-91A5-59053B6206F0}");
    ...
    public static final UUID ID_COLLECTION_NEOPOLIS_DELCOURT = StringUtils.GUIDStringToUUID("{22889327-6635-4030-8E0D-593614183E15}");
    public static final String NOM_COLLECTION_NÉOPOLIS_DELCOURT = "Néopolis";
    public static final UUID ID_SERIE_SILLAGE = StringUtils.GUIDStringToUUID("{69302EDB-6ED6-4DA3-A2E1-65B7B12BCB51}");
    public static final UUID ID_SERIE_LANFEUST_DE_TROY = StringUtils.GUIDStringToUUID("{C6ECEA18-658A-47EA-9336-A0E710E63333}");
