...
begin
  ...
  begin
    ...
    Script.Add('  a.id_album, a.titrealbum, a.tome, a.tomedebut, a.tomefin, a.horsserie, a.integrale, a.moisparution, a.anneeparution,');
    Script.Add('  a.id_serie, s.titreserie, a.achat, a.complet, a.notation, coalesce(a.initialetitrealbum, s.initialetitreserie),');
    Script.Add('  s.initialetitreserie, au.id_univers, u.nomunivers, u.id_univers_racine, u.id_univers_parent, u.branche');
    Script.Add('from');
    Script.Add('  albums a');
    Script.Add('  left join series s on');
    Script.Add('    s.id_serie = a.id_serie');
    ...
    Script.Add('  pu.id_univers, u.nomunivers, u.id_univers_racine, u.id_univers_parent, u.branche');
    Script.Add('from');
    Script.Add('  parabd p');
    Script.Add('  left join series s on');
...
{$IFDEF DEBUG}
    Script.Add('insert into series_univers (id_serie, id_univers) select id_serie, id_univers from series where id_univers is not null;');
{$ENDIF}
