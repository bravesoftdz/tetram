...
begin
  ...
  begin
    ...
    Script.Add('  end');
    Script.Add('');
    Script.Add('  if (new.id_univers_parent is distinct from old.id_univers_parent) then begin');
    Script.Add('    if (new.id_univers_parent is null) then');
    Script.Add('      new.id_univers_racine = null;');
    Script.Add('    else');
    Script.Add('      select');
    Script.Add('        coalesce(id_univers_racine, id_univers)');
    Script.Add('      from');
    Script.Add('        univers');
    Script.Add('      where');
    ...
    Script.Add('begin');
    Script.Add('  if (new.id_univers is distinct from old.id_univers) then begin');
    Script.Add('    update albums set');
    Script.Add('      id_univers = new.id_univers,');
    Script.Add('      id_univers_racine = new.id_univers_racine');
    Script.Add('    where');
    Script.Add('      id_serie = new.id_serie;');
    Script.Add('');
    Script.Add('    update parabd set');
    Script.Add('      id_univers = new.id_univers,');
    Script.Add('      id_univers_racine = new.id_univers_racine');
    Script.Add('    where');
    Script.Add('      id_serie = new.id_serie;');
    ...
    Script.Add('create or alter trigger parabd_biu0 for parabd');
    Script.Add('active before insert or update position 0');
    Script.Add('as');
    Script.Add('begin');
    Script.Add('  if (new.id_serie is distinct from old.id_serie) then');
    Script.Add('    if (new.id_serie is null) then begin');
    Script.Add('      new.id_univers = null;');
    Script.Add('      new.id_univers_racine = null;');
    Script.Add('    end else');
    Script.Add('      select id_univers, id_univers_racine from series where id_serie = new.id_serie into new.id_univers, new.id_univers_racine;');
    Script.Add('end;');

    Script.Add('create or alter trigger albums_biu0 for albums');
    Script.Add('active before insert or update position 0');
    Script.Add('as');
    Script.Add('begin');
    Script.Add('  if (new.id_serie is distinct from old.id_serie) then');
