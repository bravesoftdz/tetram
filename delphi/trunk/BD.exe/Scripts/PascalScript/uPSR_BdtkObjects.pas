...
procedure TAlbumCompletUnivers_R(Self: TAlbumComplet; var T: TObjectList<TUnivers>);
begin
  T := Self.Univers;
end;
...
procedure TSerieCompleteUnivers_R(Self: TSerieComplete; var T: TObjectList<TUnivers>);
begin
  T := Self.Univers;
end;
