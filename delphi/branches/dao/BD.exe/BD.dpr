...
uses
  ...
  UdmDWScript in '..\BDScript.exe\DWScript\UdmDWScript.pas',
  UDW_BdtkObjects in '..\BDScript.exe\DWScript\UDW_BdtkObjects.pas',
  UDW_BdtkRegEx in '..\BDScript.exe\DWScript\UDW_BdtkRegEx.pas',
  UDW_CommonFunctions in '..\BDScript.exe\DWScript\UDW_CommonFunctions.pas',
  UDWScriptEditor in '..\BDScript.exe\DWScript\UDWScriptEditor.pas',
  UDWUnit in '..\BDScript.exe\DWScript\UDWUnit.pas',
  UdmPascalScript in '..\BDScript.exe\PascalScript\UdmPascalScript.pas',
  UPascalScriptEditor in '..\BDScript.exe\PascalScript\UPascalScriptEditor.pas',
  uPSC_BdtkObjects in '..\BDScript.exe\PascalScript\uPSC_BdtkObjects.pas',
  uPSC_BdtkRegEx in '..\BDScript.exe\PascalScript\uPSC_BdtkRegEx.pas',
  uPSC_superobject in '..\BDScript.exe\PascalScript\uPSC_superobject.pas',
  uPSI_BdtkObjects in '..\BDScript.exe\PascalScript\uPSI_BdtkObjects.pas',
  uPSI_BdtkRegEx in '..\BDScript.exe\PascalScript\uPSI_BdtkRegEx.pas',
  uPSI_superobject in '..\BDScript.exe\PascalScript\uPSI_superobject.pas',
  uPSR_BdtkObjects in '..\BDScript.exe\PascalScript\uPSR_BdtkObjects.pas',
  uPSR_BdtkRegEx in '..\BDScript.exe\PascalScript\uPSR_BdtkRegEx.pas',
  uPSR_superobject in '..\BDScript.exe\PascalScript\uPSR_superobject.pas',
