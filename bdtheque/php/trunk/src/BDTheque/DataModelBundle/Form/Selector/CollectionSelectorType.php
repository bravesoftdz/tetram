...
use BDTheque\DataModelBundle\Form\DataTransformer\CollectionToIdTransformer;
...
class CollectionSelectorType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        $transformer = new CollectionToIdTransformer($this->om);
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'invalid_message' => 'La collection sélectionnée n\existe pas',
            'hidden' => false
        ));
    }
