unit BDS.Scripts.PascalScript.Compilation.BdtkObjects;
...
uses
  Windows, Dialogs, BD.Entities.Lite, BD.Utils.StrUtils, BD.Common, BDS.DataModules.Main, DateUtils, BD.Entities.Full;
