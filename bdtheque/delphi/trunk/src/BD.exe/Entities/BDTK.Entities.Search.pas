...
uses
  BD.Utils.StrUtils, BDTK.GUI.DataModules.Main, Divers, uiblib, BD.Common, BD.Entities.Metadata, BD.Strings,
  BDTK.Entities.Dao.Lite, BD.DB.Connection;
