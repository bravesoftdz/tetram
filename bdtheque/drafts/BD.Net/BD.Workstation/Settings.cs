namespace BD.Workstation.Properties
{
    ...
    internal sealed partial class Settings
    {
        ...
        {
            if (e.PropertyName.Equals("database") || e.PropertyName.Equals("dbusername") || e.PropertyName.Equals("dbuserpassword") || e.PropertyName.Equals("dbserver") || e.PropertyName.Equals("dbservertype"))
                BD.Common.Database.BDDatabase.Database.RefreshConnection();
        }
